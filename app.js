            ...
            byChapter[c.id].map(r => React.createElement("button", { key: r.id, onClick: () => setOpenId(r.id),
              ...
              React.createElement("div", { style: { flex: 1 } },
                ...
                React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" } },
                  React.createElement("span", { style: { fontSize: 10.5, color: C.textM } }, "⏱ ", r.time, " мин · ", r.kbju.k, " ккал · ", r.kbju.p, "г белка"),
      ...
      (() => {
        ...
        return React.createElement("div", { style: { background: C.card, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "13px 14px", marginBottom: 12 } },
          React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 4 } },
            ...
            React.createElement("div", { style: { fontSize: 10.5, color: C.textL } }, "цель ~", target, " мкг/л")
          ),
          filled.length === 0
            ? React.createElement("div", { style: { fontSize: 11.5, color: C.textM, lineHeight: 1.5, padding: "8px 0" } },
                "Заполни ферритин в таблице выше — здесь появится график роста. Это главная метрика прогресса для волос.")
            : (() => {
  ...
  function TodayTab({ todayDow, DR, setTab, workoutDays, cycleAnchor, packAnchor, periodOverrides, badDay, userName }) {
    ...
    return React.createElement("div", null,
      ...
      diaryDone && !showDiary && (() => {
        ...
        return React.createElement("div", {
          style: { background: C.sandSoft, border: `0.5px solid ${C.sand}55`, borderRadius: 12, padding: "11px 14px", marginBottom: 10 }
        },
          React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
            React.createElement("div", { style: { fontSize: 12.5, color: C.sandDeep, fontWeight: 600 } }, "✓ Как ты сегодня — заполнено"),
            React.createElement("button", { onClick: () => setShowDiary(true),
              style: { padding: "6px 14px", borderRadius: 8, background: C.card, border: `0.5px solid ${C.sand}55`, fontSize: 12, color: C.sandDeep, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }
            }, "Изменить")
          ),
          parts.length > 0 && React.createElement("div", { style: { fontSize: 12, color: C.textM, marginTop: 6, lineHeight: 1.5 } }, parts.join(" · ")),
          d.note && React.createElement("div", { style: { fontSize: 11.5, color: C.textL, marginTop: 4, fontStyle: "italic", lineHeight: 1.45 } }, "«", d.note, "»")
        );
      })(),

(() => {
  ...
  const KEY_DATES = {
    ...
    forlaxStart:   mkd("2026-05-25"), // Форлакс — с 1-го дня плана
    vitDStart:     mkd("2026-05-25"), // Витамин D — с 1-го дня
    zincStart:     mkd("2026-05-30"), // Цинк — суббота недели 1
    niacinStart:   mkd("2026-06-01"), // Ниацинамид — пн недели 2
    pelvicStart:   mkd("2026-06-01"), // Курс тазового дна — пн недели 2
    perfectilStart:mkd("2026-06-04"), // Перфектил — чт недели 2
    ironStart:     mkd("2026-06-08"), // Железо — пн недели 3, через день
    ironDailyFrom: mkd("2026-06-22"), // Железо ежедневно — пн недели 5
    gymStart:      mkd("2026-06-10"), // Зал (ср + пт) — ср недели 3
    runStart:      mkd("2026-06-15"), // Бег / ходьба — пн недели 4
    pelvicEnd:     mkd("2026-08-03"), // Курс тазового дна — конец (пн, ~2 мес)
      ...
      return React.createElement("div", { style: { background: C.card, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "13px", marginBottom: 12 } },
        ...
        React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 2 } },
          cells.map((d, i) => {
            ...
            // Месячные: ярко-розовый фон + белый шрифт (бросается в глаза)
            // Пачка таблеток: спокойный фиолетовый
            // Перерыв пачки: бледно-жёлтый/кремовый (другой оттенок, не путать с месячными)

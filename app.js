          ...
          return React.createElement("div", { key: di, style: { borderTop: di > 0 ? `0.5px solid ${C.border}` : "none", background: isOpen ? C.bgWarm : (isToday ? C.oliveSoft + "55" : C.card) } },
            ...
            React.createElement("button", { onClick: () => setOpenDay(isOpen ? -1 : di),
              ...
              React.createElement("div", { style: { width: 38, flexShrink: 0 } },
                React.createElement("div", { style: { fontSize: 11, fontWeight: 600, color: isToday ? C.oliveDeep : C.textM } }, dl.slice(0, 2)),
                React.createElement("div", { style: { fontSize: 15, fontWeight: 700, color: busy || isToday ? C.text : C.textL } }, dayDate.getDate())
              ),
              React.createElement("div", { style: { flex: 1, minWidth: 0, display: "flex", flexWrap: "wrap", gap: 4, alignItems: "center" } },
                busy ? React.createElement(React.Fragment, null,
                  acts.map((a, k) => { const s = SPORT_ACTS.find(x => x.id === a.id); if (!s) return null;
                    const when = a.time || (a.tod ? todMap[a.tod] : "");
                    return React.createElement("span", { key: k, style: { fontSize: 11.5, fontWeight: 600, color: C.text, background: (actColor[a.id] || C.olive) + "22", borderRadius: 999, padding: "3px 9px" } }, s.icon, " ", s.l, when ? (" \u00b7 " + when) : ""); }),
                  pelvic && React.createElement("span", { style: { fontSize: 11.5, fontWeight: 600, color: C.pink, background: C.pink + "1e", borderRadius: 999, padding: "3px 9px" } }, "\ud83c\udf38 " + (pelvic.time || (pelvic.tod === "morning" ? "\u0443\u0442\u0440\u043e" : pelvic.tod === "evening" ? "\u0432\u0435\u0447\u0435\u0440" : "")))

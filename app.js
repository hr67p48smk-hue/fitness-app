    ...
    return React.createElement("div", null,
      ...
      !diaryDone && !showDiary && React.createElement("div", {
        ...
        React.createElement("div", null,
          ...
          React.createElement("div", { style: { fontSize: 11, color: C.textM, marginTop: 2 } }, "минутка внимания к себе")
        ),
      ...
      diaryDone && !showDiary && (() => {
        ...
        const energyLabels = ["", "нет сил", "мало", "ок", "хорошо", "много"];
        const gutWords = { soft: "мягкий", norm: "норма", hard: "твёрдый", blood: "есть кровь", skip: "не было" };
        const chips = [];
        if (d.mood) chips.push({ l: "настроение", v: moodWords[d.mood] || "—" });
        if (d.energy) chips.push({ l: "энергия", v: energyLabels[d.energy] || "—" });
        if (d.gut) chips.push({ l: "ЖКТ", v: gutWords[d.gut] || "—" });
        return React.createElement("div", {
          style: { background: C.card, border: `1px solid ${C.olive}44`, borderRadius: 14, padding: "13px 15px", marginBottom: 10 }
        },
          // Шапка: галочка + заголовок + «изменить»
          React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: chips.length || d.note ? 11 : 0 } },
            React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 9 } },
              React.createElement("div", { style: { width: 24, height: 24, borderRadius: "50%", background: C.olive, color: "#fff", fontSize: 13, fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, "✓"),
              React.createElement("div", null,
                React.createElement("div", { style: { fontSize: 13.5, color: C.text, fontWeight: 700, lineHeight: 1.2 } }, "Как ты сегодня"),
                React.createElement("div", { style: { fontSize: 11, color: C.oliveDeep, marginTop: 1 } }, "отмечено сегодня")
              )
            ),
            React.createElement("button", { onClick: () => setShowDiary(true),
              style: { background: "none", border: "none", padding: "4px 2px", fontSize: 12.5, color: C.oliveDeep, fontWeight: 600, cursor: "pointer", fontFamily: "inherit", textDecoration: "underline", textUnderlineOffset: 3 }
            }, "изменить")
          ),
          // Сводка чипами label/value — аккуратно, без эмодзи
          chips.length > 0 && React.createElement("div", { style: { display: "flex", gap: 7, flexWrap: "wrap" } },
            chips.map((c, i) => React.createElement("div", { key: i, style: { background: C.bgWarm, borderRadius: 9, padding: "6px 10px", display: "flex", flexDirection: "column", gap: 1 } },
              React.createElement("div", { style: { fontSize: 9.5, color: C.textL, textTransform: "uppercase", letterSpacing: 0.3 } }, c.l),
              React.createElement("div", { style: { fontSize: 12.5, color: c.l === "ЖКТ" && d.gut === "blood" ? C.warn : C.text, fontWeight: 600 } }, c.v)
            ))
          ),
          d.note && React.createElement("div", { style: { fontSize: 12, color: C.textM, marginTop: 9, fontStyle: "italic", lineHeight: 1.5, paddingTop: 9, borderTop: `0.5px solid ${C.border}` } }, "«", d.note, "»")
        );
      })(),
